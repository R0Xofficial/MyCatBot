...
def main() -> None:
    ...
    application.add_handler(CommandHandler("start", start, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("help", help_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("github", github, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("owner", owner_info, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("info", entity_info_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("chatstat", chat_stat_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("cinfo", chat_info_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("ban", ban_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("unban", unban_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("mute", mute_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("unmute", unmute_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("kick", kick_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("kickme", kickme_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("promote", promote_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("demote", demote_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("pin", pin_message_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("unpin", unpin_message_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("purge", purge_messages_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("report", report_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("listadmins", list_admins_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("admins", list_admins_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("gif", gif, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("photo", photo, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("meow", meow, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("nap", nap, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("play", play, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("treat", treat, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("zoomies", zoomies, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("judge", judge, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("fed", fed, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("attack", attack, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("kill", kill, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("punch", punch, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("slap", slap, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("bite", bite, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("hug", hug, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("status", status, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("say", say, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("leave", leave_chat, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("speedtest", speedtest_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("blist", blacklist_user_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("unblist", unblacklist_user_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("gban", gban_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("ungban", ungban_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("enforcegban", enforce_gban_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("listsudo", list_sudo_users_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("addsudo", add_sudo_command, filters=filters.Update.MESSAGE))
    application.add_handler(CommandHandler("delsudo", del_sudo_command, filters=filters.Update.MESSAGE))
